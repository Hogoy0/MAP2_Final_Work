$(document).ready(function () {
  ...
  function endGame() {
    ...
    if (score >= 80) {
      $("#game-container").css(
        "background-image",
        "url(./img/result_success.png)"
      ); // 성공 이미지
    } else {
      $("#game-container").css(
        "background-image",
        "url(./img/result_fail.png)"
      ); // 실패 이미지
    }
    $("#game-container").append('<div class="restart-button"></div>');
    $("#game-container").append('<div class="mainmenu-button"></div>');
  }
